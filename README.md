...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dnansumpw/tags). For example,

```javascript
dnansumpw = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnansumpw@v0.0.11-umd/browser.js' )
```
